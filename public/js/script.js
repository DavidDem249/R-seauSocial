$(window).on("load", function() {
    ...
    //  ============= POST PUB POPUP FUNCTION =========

    $(".post-pub").on("click", function(){
        $(".post-popup.pst-pub").addClass("active");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".post-project > a").on("click", function(){
        $(".post-popup.pst-pub").removeClass("active");
    ...
    $(".box-photo-galery").on("click", function(){
        $("#photo-galery-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#photo-galery-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });

    //===============PHOTO Couverture Edit=======================

    $(".box-photo-cov").on("click", function(){
        $("#photo-cov-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#photo-cov-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
    ...
    $(".box-photo").on("click", function(){
        $("#photo-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#photo-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
